...
def simulation():
    ...
    java_cmd = [
        ...
        '@/var/folders/gg/1jfz30d15h309vq0rylkp93m0000gp/T/cp_7f77ddlau3ch5t7uzk5sqkp4p.argfile',
        'p.App'
    ]
    ...
    q_value = pickle.load(open('q.pickle', 'rb'))
...
def train():
    ...
    java_cmd = [
        '/Library/Java/JavaVirtualMachines/jdk-13.0.1.jdk/Contents/Home/bin/java',
        '-Dfile.encoding = UTF-8',
        '@/var/folders/gg/1jfz30d15h309vq0rylkp93m0000gp/T/cp_dwky7obyc6a0y3200yo6g17jp.argfile',
        'p.App'
    ]
    ...
    pickle.dump(results[1], open('q.pickle', 'wb'))
